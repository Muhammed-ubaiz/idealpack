...
export default function BlogCta() {
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div className="max-w-[1180px] mx-auto rounded-2xl border border-white bg-white px-6 sm:px-10 py-14 sm:py-16 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <FillButton to="/products" variant="cta">Explore Products</FillButton>
